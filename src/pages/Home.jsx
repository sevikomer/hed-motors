...
const Home = () => {
  return (
    <>
    <div className='grid lg:grid-cols-2 md:grid-cols-1 bg-slate-200 lg:m-16 m-4 rounded-3xl items-center place-content-center p-6'>
      <div className=''>
<div className='my-12 font-extrabold lg:text-6xl text-4xl'>Votre spécialiste BMW & Mini</div>
...
<button
                type="submit"
                className="flex justify-center rounded-3xl bg-red px-3 py-1.5 lg:text-lg font-semibold text-white shadow-sm hover:bg-rose-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red"
              >
                En savoir plus
              </button>
              </div>
